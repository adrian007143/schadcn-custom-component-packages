const FIELD_TYPES = [
  ...
  { value: "NUMBER", description: "Numeric stepper with increment/decrement" },
  ...
  { value: "MULTI_SELECT", description: "Multi-value selector with tags" },
  ...
  { value: "RADIO_GROUP", description: "Radio button group" },
  { value: "SLIDER", description: "Range slider with min/max" },
  { value: "OTP", description: "One-time password digit input" },
